...
#                                5. 람다식 | map ( 각원소를 2씩 곱할수있다. ) | filter (배열에서 짝수인경우만 퉤)
...
#                                           13.리스트 append sort reverse index insert remove pop count extend
a = [50, 20, 3, 4, 5]
a.append(6)
...
#                                                   15. python - 덱 ( 큐대신 댁을 쓰기. 큐는 시퀀서가 아니다.)
